...
alias encenderLEDs='curl -X POST "http://192.168.0.2/light/leds_habitacion/turn_on?brightness=240&r=255&g=255&b=255&effect=none"'
alias getLEDsState='curl -X GET "http://192.168.0.2/light/leds_habitacion"'
